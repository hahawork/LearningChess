...
public class ColocarPiezasActivity extends EjercicioBaseActivity {
    ...
    protected boolean onColocar(char pieza, int colDestino, int filaDestino) {
        ...
        switch (pieza) {
            case 'P':
                salida = filaDestino == 1;
                break;
            case 'T':
                salida = filaDestino == 0 && (colDestino == 0 || colDestino == 7);
                break;
            case 'C':
                salida = filaDestino == 0 && (colDestino == 1 || colDestino == 6);
                break;
            case 'A':
                salida = filaDestino == 0 && (colDestino == 2 || colDestino == 5);
                break;
            case 'D':
                salida = filaDestino == 0 && colDestino == 3;
                break;
            case 'R':
                salida = filaDestino == 0 && colDestino == 4;
                break;
            default:
                salida = false;
        }
        if (salida) {
            ...
            switch (pieza) {
                ...
                case 'T':
                    ...
                    resaltarCasilla(0, 0, Movimiento.CORRECTO);
                    resaltarCasilla(7, 0, Movimiento.CORRECTO);
                    break;
                case 'C':
                    avatar.habla(R.raw.colocar_piezas_mal_caballo);
                    resaltarCasilla(1, 0, Movimiento.CORRECTO);
                    resaltarCasilla(6, 0, Movimiento.CORRECTO);
                    break;
                case 'A':
                    avatar.habla(R.raw.colocar_piezas_mal_alfil);
                    resaltarCasilla(2, 0, Movimiento.CORRECTO);
                    resaltarCasilla(5, 0, Movimiento.CORRECTO);
                    break;
                case 'D':
