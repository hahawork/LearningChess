...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botonAprender = findViewById(R.id.botonAprender);
        botonAprender.setTypeface(fuente);
    ...
    public void botonAprender(View view) {
        startActivity(new Intent(this, MainActivity.class));
    }

    public void botonPracticar(View view) {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_Usuarios:
                    startActivity(new Intent(Home.this, userManejarUsuarios.class));
                    return true;
                case R.id.action_Progreso:
                    startActivity(new Intent(Home.this, userProgreso.class));
                    return true;
                ...
                case R.id.action_Ayuda:
                    startActivity(new Intent(Home.this, Ayuda.class));
                    return true;
                default:
            }
            return false;
